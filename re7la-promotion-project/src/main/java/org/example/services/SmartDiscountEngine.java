...
public class SmartDiscountEngine {
    ...
    public void recalculateAll() {
        ...
        for (Promotion p : actives) {
            ...
            if (newDiscount != p.getDiscountPercentage()) {
                updateDiscountInDB(p.getId(), newDiscount, p.getDiscountPercentage());
    ...
    public void recalculateForPromo(int promoId) {
        ...
        if (newDiscount != target.getDiscountPercentage()) {
            updateDiscountInDB(promoId, newDiscount, target.getDiscountPercentage());
    ...
    private void updateDiscountInDB(int promoId, float newDiscount, float oldDiscount) {
