...
public class PackSuggestionService {
    ...
    private Map<Integer, List<OfferRef>> loadPromoOffers() {
        ...
        } catch (Exception e) { System.err.println("[PackSuggestionService] " + e.getMessage()); }
        return map;
    }
    ...
    private String typeLabel(TargetType t) {
        return switch (t) { case HEBERGEMENT -> "Hébergement"; case ACTIVITE -> "Activité"; case VOITURE -> "Voiture"; };
    }
    ...
    private String  getStr(JsonObject o, String k, String d)    { try { return o.get(k).getAsString();  } catch(Exception e){ return d; } }
    private float   getFloat(JsonObject o, String k, float d)   { try { return o.get(k).getAsFloat();   } catch(Exception e){ return d; } }
    private double  getDouble(JsonObject o, String k, double d) { try { return o.get(k).getAsDouble();  } catch(Exception e){ return d; } }
