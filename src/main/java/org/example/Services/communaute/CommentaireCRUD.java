...
public class CommentaireCRUD implements CRUD<Commentaire> {
    ...
    public List<Commentaire> getCommentsByPublicationId(int idPublication) throws SQLException {
        ...
        while (rs.next()) {
            ...
            int commentaireId = rs.getInt("idCommentaire");  // <- fixed
            int userId = rs.getInt("id_utilisateur");        // <- fixed
            int publicationId = rs.getInt("idPublication"); // <- fixed
            ...
            Commentaire commentaire = new Commentaire(
                    commentaireId,
                    publication,
                    rs.getString("contenuC"), // content text
                    user
            );
