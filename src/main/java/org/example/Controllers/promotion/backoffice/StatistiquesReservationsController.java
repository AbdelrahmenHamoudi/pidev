...
import org.example.Utils.AnimationHelper;  // ✅ Correction du package
import org.example.Utils.MyBD;              // ✅ Ajout de l'import MyBD
...
public class StatistiquesReservationsController implements Initializable {
    ...
    private void loadKpis() {
        try (Connection conn = MyBD.getInstance().getConnection()) {  // ✅ Correction
