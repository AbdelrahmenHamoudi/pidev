...
import org.example.Services.promotion.PromotionService;         // ✅
...
public class MesReservationsController implements Initializable {
    ...
    private void redirectToLogin() {
        try {
            ...
            Stage stage = (Stage) (reservationsContainer != null ?
    ...
    private void loadReservations() {
        ...
        List<ReservationPromo> reservations = reservationService.getByUserId(currentUser.getId());
    ...
    private void handleModifier(ReservationPromo reservation) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/promotion/views/frontoffice/ModifierReservationDialog.fxml"));
            Parent root = loader.load();
